...
git clone https://github.com/xmxrtyx/vendor_xiaomi_trinket-common vendor/xiaomi/trinket-common
git clone https://github.com/xmxrtyx/device_xiaomi_trinket-common device/xiaomi/trinket-common
