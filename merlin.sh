...
git clone https://github.com/xmxrtyx/device_motorola_msm8916-common device/motorola/msm8916-common

# Kernel tree
echo -e "\n================== Cloning Kernel tree for merlin ==================\n"
git clone https://github.com/xmxrtyx/kernel_motorola_msm8916 kernel/motorola/msm8916
